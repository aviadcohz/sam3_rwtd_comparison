...
Reads eval_results/sam3_oracle_points/ and produces:
...
def generate_thumbnails():
    ...
    count = 0
    # Match new naming: {crop}_{01_gt,02_baseline,03_oracle,04_qwen}.png
...
def generate_results_json():
    ...
    approach_csvs = {
        "generic": "metrics_generic.csv",
        "oracle_text": "metrics_oracle_text.csv",
        "points_only": "metrics_points_only.csv",
        "oracle_text_points": "metrics_oracle_text_points.csv",
        "qwen3_text_proposal": "metrics_qwen3_text.csv",
        "qwen3_text_semseg": "metrics_qwen3_semseg.csv",
        "qwen3_clipseg": "metrics_qwen3_clipseg.csv",
    }

    per_sample = {}
    for key, csv_name in approach_csvs.items():
